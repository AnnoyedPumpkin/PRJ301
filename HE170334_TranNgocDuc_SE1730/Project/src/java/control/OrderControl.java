...
public class OrderControl extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            email.setFrom("snowhead2003@gmail.com"); //chinh lai email quan tri tai day [chu y dung email con hoat dong]
            email.setFromPassword("vdfphxpfawoyules"); //mat khau email tren
